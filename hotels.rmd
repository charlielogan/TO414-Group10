...
#Clean the Data
hotels_bookings$is_canceled<-as.factor(hotels_bookings$is_canceled)
...
### Cancellations based on Group Composition
...
### Cancellations based on Previous Instance of Cancellations
```{r echo=FALSE}

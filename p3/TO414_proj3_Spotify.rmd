...
The audio features dataset contains a combination of objective and subjective musical attributes.

Objective attributes of a musical track which are available in this dataset include:
...
Subjective attributes of a musical track which are available in this dataset, calculated in function of other measured properties, include:

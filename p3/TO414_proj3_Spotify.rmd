...
Overall, this project provided us with many different insights on the audio features of songs, and the popularity and danceability scores that result. Given a specific stakeholder, such as music producers, artists, advertisers, music platform executives, etc., we are confident that we can provide them with significant business insights based on our models. 

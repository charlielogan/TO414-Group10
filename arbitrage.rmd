...
corrtest <- data.frame(listings$principal_balance,listings$amount_funded, listings$listing_term, listings$prosper_score, listings$monthy_debt, listings$total_inquiries)
cor(corrtest)
```
